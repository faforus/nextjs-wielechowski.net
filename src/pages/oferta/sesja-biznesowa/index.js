...
const Business = () => {
  ...
  useEffect(() => {
    ...
    if (webpSupported) {
      images = importAll(
        require.context(
          `../../../../public/webpimages/galleries/studio/business/`,
          true,
          /\.(webp)$/
        )
      );
      ...
      images = importAll(
        require.context(
          `../../../../public/images/galleries/studio/business/`,
          true,
          /\.(jpe?g)$/
        )
      );
            ...
            <div className={classes.main}>
              <div className={classes["main-container"]}>
                <div className={classes["main-left"]}>
                  <p>
                    Zdjęcia na tle jednolitym w studiu lub w przestrzeni
                    firmowej*{" "}
                  </p>
                  ...
                  <p>
                    Tła: głównie w odcieniach szarości - od bieli przez szarość
                    do czerni. Dostępne też kolorowe.
                  </p>
                </div>
              ...
              <div className={classes["additional-info-container"]}>
                <p>
                  * Możliwy dojazd do biura/firmy klienta, gdzie zdjęcia zostaną
                  wykonane w przestrzeni biurowej/firmowej przy użyciu lamp. W
                  grę wchodzą również obszary znajdujące się poza biurem, np.
                  fabryki..
                </p>
                <p>
                ...
                <p>
                  **** istnieje możliwość przewiezienia i ustawienia studia w
                  miejscu dogodnym dla klienta. Minimalny rozmiar pomieszczenia
                  to 4x5m i 3m wyskości. Okna muszą być zakrywane. Czas
                  rozstawienia i przetestowania studia to około godziny. Cena
                  zależy od lokalizacji i ilości zdjęć.
                </p>
              </div>
            </div>
          </div>
